"""Download lexical similarity benchmarks: RG-65, WordSim-353, SimLex-999."""
...
# RG-65 — fetched from mfaruqui/eval-word-vectors (Faruqui's CMU mirror)
...
# RG-65 French — sourced from Hussain et al. (2020) Mendeley dataset.
